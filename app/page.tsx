...
import { classifyDeviceKind, selectDeviceView } from "../lib/device-views";
...
export default function Home(){
  ...
  const viewDevices=useMemo(()=>selectDeviceView(homeDevices,deviceView),[homeDevices,deviceView]);
