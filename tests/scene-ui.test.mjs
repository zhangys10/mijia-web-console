...
test("scene editor supports safe create and update workflows", async () => {
  ...
  assert.match(source, /mapScenePropertySemantics\(selectedSemantics,specification\.groups,preferredService\)/, "targets must be filtered by selected properties, values, and concrete repeated service");
