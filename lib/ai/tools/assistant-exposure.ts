...
export async function updateAssistantExposure(
  ...
  input: unknown,
  actorPrincipalId: string,
  dependencies: { homes?: typeof listHomes; devices?: typeof listDevices; sceneCatalog?: typeof loadAgentScenes; store?: AssistantExposureStore; env?: ExposureEnvironment } = {},
